...
def check_skeleton_dir(skel_dir):
    ...
    if os.path.isdir(skel_dir):
        ...
        return (False, skel_dir)#"Invalid skeleton directory. Path should be /path/to/satchmo/projects/skeleton")
    return (True, "")
...
def create_satchmo_site(site_name, skeleton_dir):
    ...
    if skeleton_dir:
        ...
        src_dir = os.path.abspath(os.path.join(clone_dir,'../satchmo/satchmo/projects/skeleton'))
